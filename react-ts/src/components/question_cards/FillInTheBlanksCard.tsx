    ...
    <Card className="p-4">
      <div className="flex flex-col gap-3">
        ...
        <Input
          ...
          className={cn(
            isCorrect ? "border-emerald-600 bg-emerald-50 dark:bg-emerald-500/10" : isEmpty ? "" : "border-rose-500 bg-rose-50 dark:bg-rose-500/10"
          )}
        />
        {showAnswer && (
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-2">
              {q.choices?.map((c, idx) => (
                <div key={`${q.id}-choice-${idx}`} className="flex items-center gap-2 rounded-md border p-2 bg-green-50 border-green-200">
