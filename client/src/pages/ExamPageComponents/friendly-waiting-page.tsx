...
type FriendlyWaitingPageProps = {
  startTime: Date;
  title: string;
};

function FriendlyWaitingPage({ startTime, title }: FriendlyWaitingPageProps) {
  return (
      ...
      <Card className="w-2/4">
        <CardContent className="flex flex-col">
          <div className="flex justify-between">
            <div>
              <p className="font-semibold">Friendly exam lobby</p>
...
export default FriendlyWaitingPage;
